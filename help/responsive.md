...
Med tanke på de många olika sätt som dessa komponenter kan uppvisa responsiva beteenden, och med tanke på Adobe engagemang för att hålla kärnkomponenterna enkla och körklara, lämnas ansvaret för att implementera detaljerade responsiva aspekter avsiktligt till projektet.
