...
>[!CAUTION]
>
>Huvudkomponenter [kräver AEM 6.4 eller senare](/help/versions.md) och [redigerbara mallar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/templates.html) måste användas. De fungerar inte med det klassiska användargränssnittet och inte heller med statiska mallar.
...
Stilarna för de flesta kärnkomponenter kan definieras med hjälp av AEM-stilsystemet.
