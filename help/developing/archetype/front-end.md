...
Framtend-modulen är tillgänglig med ett [AEM clientlib.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/full-stack/clientlibs.html?lang=sv-SE). När NPM-byggskriptet körs skapas appen och `aem-clientlib-generator` -paketet tar det resulterande build-resultatet och omvandlar det till ett sådant clientlib.
...
>[!TIP]
>
>Läs mer om hur AEM hanterar klientlibs i [AEM-utvecklingsdokumentationen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/full-stack/clientlibs.html?lang=sv-SE) om hur du inkluderar dem i [dokumentationen för kärnkomponenter.](/help/developing/including-clientlibs.md)
