...
* **Commerce-aktiverad:** För projekt som vill integrera [AEM Commerce](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content-and-commerce/home.html?lang=sv-SE) med handelslösningar som [Magento](https://magento.com/) med [Commerce Core-komponenterna](https://github.com/adobe/aem-core-cif-components).
