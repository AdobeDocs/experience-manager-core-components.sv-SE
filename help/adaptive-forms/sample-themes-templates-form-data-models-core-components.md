...
**Hur skaffar jag dessa teman?**
Du får dessa teman genom att följa stegen nedan för **AEM as a Cloud Service** -miljön:

<!-- 1. [Enable Adaptive Form Core Components](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/setup-configure-migrate/enable-adaptive-forms-core-components.html?lang=sv-SE) -->
